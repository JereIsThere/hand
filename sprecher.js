...
const CATALOG = [
  ...
  { id: 'ATLAS-flux-2-pro',     family: 'atlascloud', label: 'Flux 2 Pro',      provider: 'atlascloud', group: 'image' },
  { id: 'ATLAS-imagen-4-ultra', family: 'atlascloud', label: 'Imagen 4 Ultra',  provider: 'atlascloud', group: 'image' },
  { id: 'ATLAS-ideogram-v3',    family: 'atlascloud', label: 'Ideogram v3',     provider: 'atlascloud', group: 'image' },
  { id: 'ATLAS-z-image-turbo',  family: 'atlascloud', label: 'Z-Image Turbo',   provider: 'atlascloud', group: 'image' },
  { id: 'ATLAS-seedream-5',     family: 'atlascloud', label: 'Seedream 5',      provider: 'atlascloud', group: 'image' },
